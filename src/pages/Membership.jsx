        ...
        <div className="w-full">
            <center>
                <div className=" max-w-5xl border-cyan-500 bg-gray-50 w-3/4 md:w-full p-5 flex flex-col space-y-5">
                    ...
                    <h1 className="text-2xl md:text-3xl font-bold text-center text-gray-700 mb-8">Our Membership ensures the quality books delivered to you every month worth 1000rs to build your child's Library.</h1>
                    ...
                    <div className="flex flex-col space-y-6 md:flex-row md:space-y-0 md:space-x-6">
                        ...
                        <Card className="w-full md:w-1/3 border-2 border-cyan-400 dark:bg-slate-50">
                            <h5 className="mb-4 text-xl font-medium text-gray-500 dark:text-gray-400">6 month plan</h5>
                            <div className="flex items-baseline text-gray-900 dark:text-white">
                                <span className="text-3xl font-semibold text-black">$</span>
                                <span className="text-5xl font-extrabold tracking-tight text-black">799</span>
                                <span className="ml-1 text-xl font-normal text-gray-500 dark:text-gray-400">/month</span>
                            </div>
                            <ul className="my-7 space-y-5">
                    ...
                    <h2 className="mb-2 text-lg font-semibold text-gray-900 text-center">Why Doodle Dreams?</h2>
